...
function loadFonts()
    ...
    dialog_addFont("font_both", 255, 197, 102, 162, 244, 255)

    dialog_addFont("font_viking1", 128, 128, 255, 255, 255, 128)
    dialog_addFont("font_viking2", 255, 180, 100, 255, 255, 128)
    dialog_addFont("font_viking3", 255, 96, 96, 255, 180, 100)
    dialog_addFont("font_viking4", 255, 180, 100, 128, 255, 255)
    dialog_addFont("font_viking5", 255, 192, 128, 255, 255, 0)
    dialog_addFont("font_viking6", 128, 255, 255, 255, 255, 255)

    dialog_addFont("font_viking8", 255, 255, 128, 255, 96, 96)
end
