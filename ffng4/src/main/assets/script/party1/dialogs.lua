dialog_add("pt1-m-parnicek", "small", {
  cs="Hleďme. Výletní parníček.",
  en="Look. The party boat."})

dialog_add("pt1-v-predtucha", "big", {
  cs="Mám takovou předtuchu, že to nebudou žádní normální výletníci.",
...
dialog_add("pt1-m-kostlivec", "small", {
  cs="Možná, žes měl pravdu. Jsou to divní výletníci.",
...
dialog_add("pt1-v-valec", "big", {
  cs="To chceš podepřít ten ocelový válec skleničkou?",
  en="You want to support that steel tube with a glass?"})

dialog_add("pt1-m-nemuzu", "small", {
  cs="Víc pro tebe udělat nemůžu.",
  en="I can’t do anything else for you."})

dialog_add("pt1-v-pozor", "big", {
  cs="Pozor, ať to nevyliješ!",
  en="Be careful not to spill it!"})
