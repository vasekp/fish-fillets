dialog_add("gr-m-gral", "small", {
  cs="Támhle to uprostřed, to je nepochybně Svatý grál!",
  en="That thing over there must be Holy Grail!"})

dialog_add("gr-v-jiste", "big", {
  cs="Jak si můžeš být tak jistá?",
  en="How can you be so sure?"})

dialog_add("gr-m-zare0", "small", {
  cs="Nevidíš svatozář?",
  en="Can’t you see that halo?"})

dialog_add("gr-m-zare1", "small", {
  cs="Nevidíš, jak mezi těmi ostatními září?",
  en="Can’t you see how it glows among the others?"})

dialog_add("gr-m-zare2", "small", {
  cs="Copak nevidíš, jak výrazně je umístěn ve středu celé jeskyně na vyvýšeném místě?",
...
dialog_add("gr-v-nic1", "big", {
  cs="Není všechno zlato, co se třpytí. Nikde není psáno, že Svatý grál musí zářit.",
...
dialog_add("gr-v-tuseni", "big", {
  cs="Mám takové tušení, že to bude jinak, než se zdá.",
...
dialog_add("gr-m-svaty0", "small", {
  cs="Pojď, odneseme odsud ten prostřední zářící grál se svatozáří.",
  en="Let’s go, we shall take that central glowing Grail with us."})

dialog_add("gr-v-vsechny0", "big", {
  cs="Já bych je raději odnesl všechny.",
  en="I’d rather take all of them."})

dialog_add("gr-m-vsechny0", "small", {
  cs="Hmmm... zdá se, že jsi měl pravdu. Vezmeme je všechny.",
...
dialog_add("gr-v-vsechny1", "big", {
  cs="Ne, všechny grály!",
  en="No, to push out all the Grails."})

dialog_add("gr-m-jensvaty", "small", {
  cs="Stačí ten svatý.",
