dialog_add("sp-v-no0", "big", {
  cs="No tohle!",
  en="Lo and behold!"})

dialog_add("sp-m-no1", "small", {
  cs="No teda!",
  en="Just imagine!"})

dialog_add("sp-v-kdoby", "big", {
  cs="Kdo by to řekl?!",
  en="Who could have guessed?!"})

dialog_add("sp-m-neopatrnost", "small", {
  cs="Taková neopatrnost.",
...
dialog_add("sp-v-trapne", "big", {
  cs="Trapné přehlédnutí.",
...
dialog_add("sp-v-vratit0", "big", {
  cs="Můžem ho zkusit vrátit na místo.",
...
dialog_add("sp-m-taky", "small", {
  cs="To si taky myslím.",
  en="I think so, too."})

dialog_add("sp-v-dotoho", "big", {
  cs="Dáme se do toho.",
  en="Let ’s get to work."})

dialog_add("sp-m-nechat", "small", {
  cs="Co kdybychom tady ten špunt prostě nechali?",
  en="What if we just leave that plug here?"})

dialog_add("sp-v-centrala", "big", {
  cs="Co by tomu řekla centrála?",
...
dialog_add("sp-m-vydrz", "small", {
  cs="Vydrž. Určitě na to přijdem.",
  en="Hold on. We are sure to solve it."})

dialog_add("sp-m-spunt", "small", {
  cs="Zatracený špunt. Co kdybychom si něco vymysleli?",
  en="The darned plug. What if we just make up something."})

dialog_add("sp-v-co", "big", {
  cs="Jako třeba co?",
  en="Like what, for example?"})

dialog_add("sp-m-vymluva0", "small", {
  cs="No třeba, že to město nikdy neexistovalo.",
  en="Well, we could say that the city in fact never existed."})

dialog_add("sp-m-vymluva1", "small", {
  cs="Třeba, že se to město potopilo, protože roztály ledovce.",
  en="Well, we could say that the city sank because the Arctic ice had melted."})

dialog_add("sp-m-vymluva2", "small", {
  cs="Například ho mohlo potopit zemětřesení.",
  en="An earthquake could have sunk the city, for example."})

dialog_add("sp-m-vymluva3", "small", {
  cs="Třeba, že ho smetla tsunami.",
  en="A tsunami might have sunk the city, for example."})

dialog_add("sp-m-vymluva4", "small", {
  cs="Můžem říkat, že na ostrově vybuchla sopka.",
  en="We could try to say that a volcano erupted in the center of the city."})

dialog_add("sp-v-nesmysl", "big", {
  cs="To je pěkný nesmysl.",
