dialog_add("zr-x-nabito", "white", {
  cs="PRVNÍ NÁBOJOVÁ KOMORA NABITA...",
...
dialog_add("zr-v-hej", "big", {
  cs="Hej, jsi tam dole?",
  en="Hey, is anybody down there?"})

dialog_add("zr-v-halo", "big", {
  cs="Haló, slyšíš mě tam uvnitř?",
  en="Hello, can you hear me in there?"})

dialog_add("zr-v-jetunekdo", "big", {
  cs="Je tu někdóóó?",
  en="Is anybody here?"})
...
dialog_add("zr-m-tadyjsem", "small", {
  cs="Tady jsem. Nemůžu se dostat ven.",
  en="Here I am. I can’t get out."})

dialog_add("zr-m-komu", "small", {
  cs="Komu můžou patřit ty oči?",
  en="Whose eyes are those?"})

dialog_add("zr-v-nevim", "big", {
  cs="Nevím, snad ten periskop vede do jiné dimenze...",
  en="I don’t know. Maybe the periscope is connected to some other dimension."})

dialog_add("zr-v-opatrne", "big", {
  cs="Opatrně...",
  en="Careful..."})

dialog_add("zr-v-vzdyt", "big", {
  cs="Vždyť jsem ti to říkal!",
