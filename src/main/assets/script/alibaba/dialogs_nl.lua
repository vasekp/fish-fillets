...
dialogStr("Van de schatkamer naar de kaarsenopslag. Dat is een vooruitgang.")


dialogId("kni-v-ber", "font_big", "You have to look on the bright side. There is nothing that looks like a grail here.")
dialogStr("Je moet het van de positieve kant bekijken. Er is hier niks dat op een graal lijkt.")
...
dialogStr("Weet je wat? Ik denk dat deze missie heel opvoedend voor me is geweest.")
