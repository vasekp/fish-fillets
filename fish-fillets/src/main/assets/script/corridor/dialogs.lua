dialog_add("ch-m-rozsvit0", "small", {
  cs="Okamžitě zase rozsviť!",
  en="Turn on the lights, NOW!"})

dialog_add("ch-m-rozsvit1", "small", {
  cs="Co děláš, rozsviť!",
  en="What do you think you are doing?"})

dialog_add("ch-m-rozsvit2", "small", {
