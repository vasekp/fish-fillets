dialog_add("zel-v-zelva0", "big", {
  cs="Ha, vidíš ji? To bude jistě ta telepatická želva.",
...
dialog_add("zel-m-fotky0", "small", {
  cs="No, já nevím, podle těch fotek by to mohla být ona.",
...
dialog_add("zel-m-coto1", "small", {
  cs="Proč jsi to udělal?",
  en="What have you done?"})

dialog_add("zel-m-coto2", "small", {
  cs="Co to mělo znamenat?",
  en="What is it supposed to mean?"})

dialog_add("zel-v-coto0", "big", {
  cs="Kam plaveš?",
  en="Where are you swimming?"})

dialog_add("zel-v-coto1", "big", {
  cs="Co tě to napadlo?",
...
dialog_add("zel-m-nevim1", "small", {
  cs="Já si nic neuvědomuju...",
  en="I can’t realize..."})

dialog_add("zel-v-nevim0", "big", {
  cs="Nevím, co se se mnou děje...",
  en="I don’t know what’s happening to me..."})

dialog_add("zel-v-nevim1", "big", {
  cs="Já nevím, to samo...",
  en="I didn’t want to..."})
...
dialog_add("zel-m-cimtoje", "small", {
  cs="Čím to může být způsobeno?",
  en="What can it mean?"})

dialog_add("zel-m-tazelva", "small", {
  cs="To dělá ta želva!",
  en="This must be that turtle!"})

dialog_add("zel-v-tazelva", "big", {
  cs="To dělá ta želva!",
  en="This must be that turtle!"})
...
dialog_add("zel-v-pochyby", "big", {
  ...
  en="Doubtless, this is the turtle we are looking for!"})

dialog_add("zel-m-potvora0", "small", {
  cs="Ta potvora!",
  en="That beast!"})

dialog_add("zel-m-potvora1", "small", {
  cs="Nech toho, ty mrcho!",
  en="Stop it, you devil!"})

dialog_add("zel-v-stacit0", "big", {
  cs="To už by tedy mohlo stačit!",
  en="Enough is enough!"})

dialog_add("zel-v-stacit1", "big", {
  cs="Bavíš se dobře?",
  en="Are you enjoying yourself?"})

dialog_add("zel-v-bizarni", "big", {
  cs="Tolik bizarních tvarů se najde jen na korálovém útesu.",
  en="So many bizarre shapes can only be found in a coral reef."})

dialog_add("zel-m-priroda", "small", {
  cs="Příroda se na těch korálech vyřádila.",
  en="These corals are Mother Nature’s wonders."})

dialog_add("zel-v-tvary", "big", {
  cs="Jak může vzniknout tolik bizarních tvarů?",
