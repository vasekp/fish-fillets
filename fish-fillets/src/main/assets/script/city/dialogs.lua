...
dialog_add("vit-hs-reklama2", "white", {
...
dialog_add("vit-hs-dite0", "statue", {
...
dialog_add("vit-m-jakze", "small", {
  cs="Jakže, rybí jídelnu?",
  en="What?! A fish restaurant?"})

dialog_add("vit-v-vazne", "big", {
  cs="To myslíte vážně?",
  en="Are you serious?"})

dialog_add("vit-m-nechutne", "small", {
  cs="Jak nechutné!",
  en="How disgusting!"})

dialog_add("vit-v-nevsimla", "big", {
...
dialog_add("vit-m-tak", "small", {
  cs="...tak...?",
  en="...then...?"})

dialog_add("vit-v-pockej", "big", {
