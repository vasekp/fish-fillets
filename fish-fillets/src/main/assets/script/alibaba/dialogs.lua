...
dialog_add("kni-v-prolezt", "big", {
  cs="Zdá se, že budu muset prolézt tím strašným bludištěm.",
  en="It seems that I’ll have to go through that horrible maze."})

dialog_add("kni-m-tloustka", "small", {
  cs="Ta tvoje tloušťka. Ta nás vždycky zdržuje.",
...
dialog_add("kni-v-vypni", "big", {
  cs="Mohl bys, prosím tě, restartovat level? Zdá se, že nám to teď spolu moc nejde.",
  en="Could you restart the level, please? We don’t seem to be getting along very well now."})

dialog_add("kni-m-hrncirstvi", "small", {
  cs="Připadám si tu jako ve skladu hrnčířství.",
  en="I feel like I am in the pottery warehouse."})

dialog_add("kni-v-amforstvi", "big", {
  cs="Chceš říci: amfórství.",
  en="You mean, amphory warehouse."})

dialog_add("kni-m-amfornictvi", "small", {
  cs="Když už, tak: amfórnictví.",
  en="No, it should be amphora warehouse."})

dialog_add("kni-m-mise", "small", {
  cs="Víš, myslím, že tahle celá jeskynní mise mi hodně pomohla.",
...
dialog_add("kni-m-kramy", "small", {
  cs="Už ty krámy nemůžu ani vidět!",
  en="I can’t bear the darned stuff any longer!"})
