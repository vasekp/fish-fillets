dialog_add("1st-m-cotobylo", "small", {
  cs="Co to bylo?",
  en="What was that?"})

dialog_add("1st-v-netusim", "big", {
  cs="Nemám tušení.",
  en="I have no idea."})

dialog_add("1st-v-ven", "big", {
...
dialog_add("1st-m-neprojedu", "small", {
...
dialog_add("1st-v-nedostanu", "big", {
